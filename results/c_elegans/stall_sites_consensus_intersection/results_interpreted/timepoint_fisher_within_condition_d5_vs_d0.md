...
<!-- INTERP_AA_START -->
_TODO: hand-authored interpretation of the Amino Acid plots/data goes here (Stage 2)._
<!-- INTERP_AA_END -->
...
<!-- INTERP_CODON_START -->
_TODO: hand-authored interpretation of the Codon plots/data goes here (Stage 2)._
<!-- INTERP_CODON_END -->

## Key Points

<!-- KEY_POINTS_START -->
_TODO: hand-authored overall Key Points go here (Stage 2)._
<!-- KEY_POINTS_END -->
