...
- **large-N-Fisher-anticonservative** *(family-wide)* — pooled totals 6945 / 8788 / 11177 / 11935. Tiny effects yield p_adj < 1e-7 (control,P,G `log2_OR`=+0.430 → 5.80e-08). Rank by `log2_OR`. (Inherited.)
