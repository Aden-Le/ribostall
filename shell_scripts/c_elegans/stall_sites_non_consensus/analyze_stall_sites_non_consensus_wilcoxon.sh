...
OUTPUT_DIR="./results/c_elegans/stall_sites_non_consensus/plots/between_condition"
...
BT_OUTPUT_DIR="./results/c_elegans/stall_sites_non_consensus/plots/between_timepoint"
