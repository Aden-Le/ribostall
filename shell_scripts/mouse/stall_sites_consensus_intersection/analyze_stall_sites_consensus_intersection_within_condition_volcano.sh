#!/bin/bash
#----------------------------------------------------
# Within-Condition Enrichment Volcano Plots (CONSENSUS INTERSECTION stall_sites) — MOUSE, FLAT DESIGN
...
OUTPUT_DIR="./results/mouse/stall_sites_consensus_intersection/plots/within_condition"
...
echo "=============================================="
echo "CONSENSUS INTERSECTION STALL SITES WITHIN-CONDITION VOLCANO PLOTS (MOUSE, FLAT DESIGN)"
echo "=============================================="
